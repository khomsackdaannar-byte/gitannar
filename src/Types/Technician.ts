...
export const techList: Technician[] = [
  { name: "ທ້າວ ສັກ ພັນທະວົງ", type: "ຊ່າງສ້ອມແປງໄຟຟ້າ", category: TechCategory.electric, phone: "02055512345", area: "ເມືອງໄຊທານີ", hometown: "ບ້ານໂພນເຄັງ ເມືອງໄຊເສດຖາ ນະຄອນຫລວງວຽງຈັນ", birthDate: "20/03/1995", age: "31", rating: 4.8, icon: "electrical_services", image: "/assets/images/somsack.jpg" },
  ...
  { name: "ທ້າວ ແສງໄຊ ວົງສາ", type: "ຊ່າງສ້ອມແປງໄຟຟ້າ", category: TechCategory.electric, phone: "02055512355", area: "ເມືອງໄຊທານີ", hometown: "ບ້ານດອນຫນູ ເມືອງໄຊທານີ ນະຄອນຫລວງວຽງຈັນ", birthDate: "29/05/1990", age: "36", rating: 4.8, icon: "electrical_services", image: "/assets/images/saengxai.jpg" },
